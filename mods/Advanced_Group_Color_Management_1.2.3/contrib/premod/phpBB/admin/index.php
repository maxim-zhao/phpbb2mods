...
//	$username,
//-- with
//	$colors->get_user_color($onlinerow_reg[$i]['user_group_id'], $onlinerow_reg[$i]['user_session_time'], $username),
//-- modify

					"USERNAME" => $colors->get_user_color($onlinerow_reg[$i]['user_group_id'], $onlinerow_reg[$i]['user_session_time'], $username), 
//-- fin mod : Advanced Group Color Management ---------------------------------

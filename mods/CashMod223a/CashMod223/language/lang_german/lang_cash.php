...
/***************************************************************************
 *                            lang_cash.php [German]
 *                              -------------------
 *     begin                : Sat Jul 20 2003
 *     copyright            : (C) 2003 Nils Adermann
 *     email                : naderman@gmx.de
 *
...
$lang['Cash_set_all'] = 'Set for all users'; /* _____________________________________________________*/
...
$lang['Cash_currency_dbfield'] = 'Dantenbank Spaltenname der Währung';
...
$lang['Set'] = 'Setzen';   /* _____________________________________________________ */
$lang['Up'] = 'Hoch';
$lang['Down'] = 'Runter';
...
$lang['Cash_imageurl'] = 'Bild (Relativ zum phpBB2 Root-Pfad):';
...
// Groups
$lang['Cash_status_type'][CASH_GROUPS_DEFAULT] = 'Default';    /* _____________________________________________________ */
...
*/
$lang['Cash_clause'][CASH_LOG_DONATE] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> verschenkte <b>%s</b> an <a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a>';
...
Set 3 points
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_MODEDIT] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new">%s</a> änderte <a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a>s Kontostand:<br />Fügte <b>%s</b> hinzu<br />Entfernte <b>%s</b><br />Setzte Kontostand auf<b>%s</b>';
...
Joe created points 
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_CREATE_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> erstellte <b>%s</b>';
...
Joe deleted $ 
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_DELETE_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> löschte <b>%s</b>';
...
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_RENAME_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> benannte <b>%s</b> in <b>%s</b> um';
...
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_COPY_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> wandelte die <b>%s</b> aller Benutzer in <b>%s</b> um';    /* _____________________________________________________ */

$lang['Log'] = 'Log';
$lang['Action'] = 'Aktion';
$lang['Type'] = 'Typ';
$lang['Cash_all'] = 'Alle';    /* _____________________________________________________ */
...
$lang['Mod_usercash'] = '%ss Kontostand verändern';
...
//
$lang['Amount'] = 'Menge';
$lang['Donate_to'] = 'An %s verschenken';     /* _____________________________________________________ */
...
$lang['Omit'] = 'Auslassen';
$lang['Amount'] = 'Kontostand';     /* _____________________________________________________ */

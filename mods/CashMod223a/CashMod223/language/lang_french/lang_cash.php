...
$lang['Cash_events_explain'] = 'Le formulaire ci-dessous vous permettra de déterminer les gains d\'argent pour des évènements personnalisés.';

$lang['No_events'] = 'Aucun évènement créé';
$lang['Existing_events'] = 'Evènements Créés';
$lang['Add_an_event'] = 'Ajouter un évènement';
$lang['Cash_events_updated'] = 'Evènements Argent Mis A Jour';
$lang['Click_return_cash_events'] = 'Cliquez %sici%s pour retourner aux Evènements Argent';
...
$lang['Cash_resetting'] = 'Remise à zéro de l\'argent';
...
$lang['Click_return_cash_reset'] = 'Cliquez %sici%s pour retourner à la Remise à Zéro de l\'argent';
...
$lang['Cash_settings_updated'] = 'Réglages du Cash Mod Mis A Jour';
...
$lang['Cash_amount_per_post'] = 'Argent gagné par nouveau topic';
$lang['Cash_amount_post_bonus'] = 'Argent bonus gagné par réponse sur le topic';
$lang['Cash_amount_per_reply'] = 'Argent gagné par réponse';
$lang['Cash_amount_per_character'] = 'Argent gagné par caractère';
$lang['Cash_maxearn'] = 'Montant maximum gagné par réponse';
$lang['Cash_amount_per_pm'] = 'Argent gagné par message privé';
$lang['Cash_include_quotes'] = 'Inclure les citations en calculant l\'argent par caractère';
...
$lang['Cash_allow_mod_edit'] = 'Permettre aux modérateurs d\'éditer l\'argent des membres';
...
Set 3 points
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_MODEDIT] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . ' ?mode=viewprofile&u=%s" target="_new">%s</a> a modifié l\'argent de <a href="' . $phpbb_root_path . 'profile.' . $phpEx . ' ?mode=viewprofile&u=%s" target="_new"><b>%s</b></a>:<br />Ajouté <b>%s</b><br />Enlevé <b>%s</b><br />Mis à <b>%s</b>';

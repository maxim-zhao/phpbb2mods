...
/***************************************************************************
 *                            lang_cash.php [Italian]
 *                              -------------------
 *     begin                : Sat Jul 20 2003
 *     copyright            : (C) 2003 Roland di Gilead
 *     email                : mods@xore.ca
 *
...
$lang['Cmenu_cash_events'] = 'Q.ta\' di valuta da assegnare per evento utente';
...
$lang['Cash_config_explain'] = 'In questa sezione e\' possibile impostare i parametri per il  Cash Mod .';

$lang['Cash_admincp'] = 'Modalita\' Pannello di controllo per Cash Mod Admin';
...
$lang['Cash_currencies_explain'] = 'In questa sezione e\' possibile gestire le varie valute.';
...
$lang['Cash_confirm_copy'] = 'Copia tutti i dati utenti da %s a %s <br /> Questa operazione non puo\' essere annullata';
$lang['Cash_confirm_delete'] = 'Cancella %s?<br />Questa opzione non puo\' essere annullata';
...
$lang['Cash_reset_explain'] = 'In questa sezione e\' possibile effettuare un reset globale per i valori delle varie valute';
...
$lang['Cash_confirm_reset'] = 'Confermate il reset delle valute selezionate? <br />Questa operazione non puo\' essere annullata';
$lang['Cash_confirm_recount'] = 'Confermate il ricalcolo delle valute selezionate? <br />Questa operazione non puo\' essere annullata..<br /><br />Questa operazione non e\' raccomandata per forum con un numero elevato di utenti e/o argomenti.<br /><br />Si raccomanda di disabilitare il forum durante questa operazione. <br /> Potete disabilitare il forum nella voce %sConfigurazione%s';
...
$lang['Forum_cm_settings_explain'] = 'Da questo pannello potete impostare in quali forum il Cash Mod e\' attivo';
...
$lang['Cash_image'] = 'Mostra la valutca come immagine';
$lang['Cash_imageurl'] = 'Immagine (Relativa al path di phpBB2 ):';
...
$lang['Cash_allow_mod_edit'] = 'Permetti ai moderatori di modificare la quantita\' della valuta dell\'utente';
...
*/
$lang['Cash_clause'][CASH_LOG_DONATE] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> regala <b>%s</b> a <a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a>';
...
Set 3 points
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_MODEDIT] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new">%s</a> ha modificato la Cassa di <a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a>\:<br />Aggiunti <b>%s</b><br />Cancellati <b>%s</b><br />Impostato a <b>%s</b>';
...
Joe created points 
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_CREATE_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> ha creato <b>%s</b>';
...
Joe deleted $ 
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_DELETE_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> ha cancellato <b>%s</b>';
...
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_RENAME_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> ha rinominato <b>%s</b> in <b>%s</b>';
...
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_COPY_CURRENCY] = '<a href="' . $phpbb_root_path . 'profile.' . $phpEx . '?mode=viewprofile&u=%s" target="_new"><b>%s</b></a> ha copiato i <b>%s</b>  dell\'utente in <b>%s</b>';
...
//
$lang['Donate'] = 'Regala';
$lang['Mod_usercash'] = 'Modifica valute';
...
$lang['Amount'] = 'Quantita\'';
$lang['Donate_to'] = 'Regala a %s';
$lang['Has_moderated'] = '%s ha moderato il tuo %s';
$lang['Has_added'] = '[*]Aggiunto: [b]%s[/b]\n';
$lang['Has_removed'] = '[*]Rimuovi: [b]%s[/b]\n';

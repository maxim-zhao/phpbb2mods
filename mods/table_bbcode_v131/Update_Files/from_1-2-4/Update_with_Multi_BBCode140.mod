...
## Author Notes: 
##
##     Only use this file if you have the Multi BBCode Mod Version 1.4.x installed. Otherwise, use the Update.mod file. 
## 
############################################################## 
## MOD History:
...
##			- Automatically centers and bolds text for new header cells anywhere
##			- Supports fontsize and color attributes
...
# IMPORTANT: you MUST first install the latest version of the Multi Quick BBCode Mod.

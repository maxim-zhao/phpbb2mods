...
$sql = array();
$sql[] = "CREATE TABLE `" . $table_prefix . "agreement` (
`config_name` varchar(100) NULL COMMENT 'The config name',
`config_value` text NULL COMMENT 'the config value'
)";
$sql[] = "INSERT INTO `" . $table_prefix . "agreement` ( `config_name` , `config_value` )
VALUES (
'agreement_body', 'This is your agreement page, please set your agreement in your Admin Control Panel.'
)";

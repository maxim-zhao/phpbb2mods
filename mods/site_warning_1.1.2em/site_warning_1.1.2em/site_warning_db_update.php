...
###################################################################################################
$sql=array(
'DELETE FROM '.CONFIG_TABLE.' WHERE config_name="site_warning"',
...
$mods = array ( 
'Site warning uninstall', 'Site warning MOD installation','Site warning MOD installation','Site warning MOD installation'
);

...
MOD Name:	Simple Colored Usergroups 
MOD Author:	Afterlife_69 and kkroo
Website:	http://www.ugboards.com and http://phpbb-login.sourceforge.net
*/

$mod_name = 'Simple Colored Usergroups';
$mod_current_version = '1.0.1';
$mod_dev_status = 'stable';
$mod_domain_loc = 'http://phpbbb-login.strangled.net';
$mod_file_name = 'scu.xml';
$mod_file_loc = 'mods';

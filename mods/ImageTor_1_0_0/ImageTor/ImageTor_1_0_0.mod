##############################################################
## MOD Title: ImageTor MOD
## MOD Author: Janmarques < gigjan@gmail.com > (Jan Marques) http://www.janmarques.be.tt
## MOD Description: This MOD adds a small ImageTor toolbar, so it's easy to upload your image quick.
## MOD Version: 1.0.0
## 
...
<!--Image in post MOD - start-->
	...
	<tr>
      <td class="row1" colspan="2" align="center" height="28"><iframe src="http://www.imagetor.com/iframe.php?bgcolor=FFFFFF&txtcolor=111111&upload=common" scrolling="no" allowtransparency="true" frameborder="0" width="290" height="100"></iframe></td>
	</tr>
 <!--Image in post MOD - stop-->
#

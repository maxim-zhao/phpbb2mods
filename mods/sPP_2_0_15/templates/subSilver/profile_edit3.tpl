...
<table border="0" cellpadding="3" cellspacing="1" width="800ox" class="forumline">
	<tr> 
		<th class="thHead" colspan="2" height="25" valign="middle" align="left"><b>{L_FORUM}</b></th>
	</tr>
	<tr> 
		<td class="row2" colspan="2"><span class="thHead"><small class="nav"><a href="profile.php?mode=editprofile&pmode=1">{L_USER}</a>&nbsp;|&nbsp;<a href="{S_PROFILE_LINK2}">{L_PROFILE}</a>&nbsp;|&nbsp;{L_FORUM}&nbsp;|&nbsp;<a href="{S_PROFILE_LINK4}">{L_AVATAR}</a></small></span></td>
	</tr>
	<tr> 

 ...
 *   *** The SQL/DDL statements contained in this script are optimized for MS-SQL only!
 *
 * - Installation:
...
//
$sql = array();
$sql[] = 'CREATE TABLE ' . $table_prefix . 'actions (
    action_id INTEGER NOT NULL IDENTITY(1, 1),
    action_name VARCHAR(50) NOT NULL,
    action_text VARCHAR(50) NOT NULL,
    action_status SMALLINT NOT NULL DEFAULT (0),
    CONSTRAINT ' . $table_prefix . 'actions_pk PRIMARY KEY (action_id) ON [PRIMARY]
)  ON [PRIMARY]';
$sql[] = 'CREATE TABLE ' . $table_prefix . 'actions_performed (
    id INTEGER NOT NULL IDENTITY(1, 1),
    action_id INTEGER NOT NULL,
    performer_id INTEGER NOT NULL,
    post_id INTEGER NOT NULL,
    action_time INTEGER NOT NULL,
    CONSTRAINT ' . $table_prefix . 'actions_performed_pk PRIMARY KEY (id) ON [PRIMARY]
)  ON [PRIMARY]';
$sql[] = 'CREATE UNIQUE INDEX ' . $table_prefix . 'performed_id ON ' . $table_prefix . 'actions_performed (action_id, performer_id, post_id) ON [PRIMARY]';
$sql_count = count($sql);

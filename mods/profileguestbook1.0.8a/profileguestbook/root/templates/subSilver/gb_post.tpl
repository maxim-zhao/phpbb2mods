...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
		...
		-> <a href="{U_PROFILE}" class="nav">{L_PROFILE}</a></span></td>
	</tr>
</table>

<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
		<th class="thHead" colspan="2" height="25"><b>{L_GB_POST}</b></th>
	</tr>
<!-- BEGIN username -->
	<tr> 
...
<!-- END username -->
	<tr> 
	  <td class="row1" width="22%"><span class="gen"><b>{L_TITLE}</b></span></td>
	  <td class="row2" width="78%"> <span class="gen"> 
		<input type="text" name="subject" size="45" maxlength="60" style="width:450px" tabindex="2" class="post" value="{TITLE}" />
		</span> </td>
	</tr>
	<tr> 

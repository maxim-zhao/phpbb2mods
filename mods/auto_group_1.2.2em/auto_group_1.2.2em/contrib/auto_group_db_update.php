...
//
$sql = array();
$sql[] = 'ALTER TABLE ' . $table_prefix . 'groups ADD group_count INTEGER(4) UNSIGNED DEFAULT 99999999';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'groups ADD group_count_max INTEGER(4) UNSIGNED DEFAULT 99999999';

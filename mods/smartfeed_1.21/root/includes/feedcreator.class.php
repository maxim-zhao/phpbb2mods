...
class FeedCreator extends HtmlDescribable {
	...
	*/
	...
	function _generateFilename() {
		...
		$fileInfo = pathinfo($HTTP_SERVER_VARS["PHP_SELF"]);
 ...
 */
 class AtomCreator10 extends FeedCreator {
	...
	function AtomCreator10() {
		...
		// MDH - Commented out next line. Feedvalidator.org does not seem to require utf-8
		//$this->encoding = "utf-8";
	}
	...
	function createFeed() {
		...
		$feed.= "    <generator>".FEEDCREATOR_VERSION."</generator>\n";
		// MDH - Next line shows original and was commented out and replaced with the one below in order to remove a Feedvalidator.org warning
		...
		for ($i=0;$i<count($this->items);$i++) {
			...
			if ($this->items[$i]->description!="") {
				// Next line modified from original by Mark D. Hamill, was: $feed.= "        <summary type="html">".htmlspecialchars($this->items[$i]->description)."</summary>\n";

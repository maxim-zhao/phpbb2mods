...
//
$sql = array();
$sql[] = 'ALTER TABLE ' . $table_prefix . 'users ADD user_smart_dates TINYINT NULL DEFAULT 1';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'smart_dates_allow\',\'1\')';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'smart_dates_time\',\'1\')';
$sql_count = count($sql);

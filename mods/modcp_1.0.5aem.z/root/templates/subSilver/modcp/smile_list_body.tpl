...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<!-- BEGIN smiles -->
	<tr>
		<td class="{smiles.ROW_CLASS}"><span class="genmed">{smiles.CODE}</span></td>
		<td class="{smiles.ROW_CLASS}"><img src="{smiles.SMILEY_IMG}" alt="{smiles.CODE}" /></td>
		<td class="{smiles.ROW_CLASS}"><span class="genmed">{smiles.EMOT}</span></td>
		<td class="{smiles.ROW_CLASS}"><span class="genmed"><a href="{smiles.U_SMILEY_EDIT}">{L_EDIT}</a></span></td>
		<td class="{smiles.ROW_CLASS}"><span class="genmed"><a href="{smiles.U_SMILEY_DELETE}">{L_DELETE}</a></span></td>
	</tr>
	<!-- END smiles -->
	<tr>
		<td class="catBottom" colspan="5" align="center">{S_HIDDEN_FIELDS}

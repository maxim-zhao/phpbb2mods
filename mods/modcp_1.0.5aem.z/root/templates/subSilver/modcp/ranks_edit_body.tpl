...
<table class="forumline" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
		<td class="row1" width="38%"><span class="genmed">{L_RANK_TITLE}:</span></td>
		<td class="row2"><input class="post" type="text" name="title" size="35" maxlength="40" value="{RANK}" /></td>
	</tr>
	<tr>
		<td class="row1"><span class="genmed">{L_RANK_SPECIAL}</span></td>
		<td class="row2">
	...
	<tr>
		<td class="row1" width="38%"><span class="genmed">{L_RANK_MINIMUM}:</span></td>
		<td class="row2"><input class="post" type="text" name="min_posts" size="5" maxlength="10" value="{MINIMUM}" /></td>
	</tr>
	<tr>
		<td class="row1" width="38%">
			<span class="genmed">{L_RANK_IMAGE}:</span><br />
			<span class="gensmall">{L_RANK_IMAGE_EXPLAIN}</span><br />
		</td>

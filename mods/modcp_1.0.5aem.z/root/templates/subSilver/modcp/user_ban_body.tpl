...
<table width="80%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row1">
			<span class="gen">{L_USERNAME}:</span><br />
			<span class="gensmall">{L_UNBAN_USER_EXPLAIN}</span></span>
		</td>
	...
	<tr>
		<td class="row1">
			<span class="gen">{L_IP_OR_HOSTNAME}:</span><br />
			<span class="gensmall">{L_BAN_IP_EXPLAIN}</span><br />
		</td>
	...
	<tr>
		<td class="row1">
			<span class="gen">{L_IP_OR_HOSTNAME}:</span><br />
			<span class="gensmall">{L_UNBAN_IP_EXPLAIN}</span><br />
		</td>
	...
	<tr>
		<td class="row1">
			<span class="gen">{L_EMAIL_ADDRESS}:</span><br />
			<span class="gensmall">{L_BAN_EMAIL_EXPLAIN}</span><br />
		</td>
	...
	<tr>
		<td class="row1">
			<span class="gen">{L_EMAIL_ADDRESS}:</span><br />
			<span class="gensmall">{L_UNBAN_EMAIL_EXPLAIN}</span><br />
		</td>

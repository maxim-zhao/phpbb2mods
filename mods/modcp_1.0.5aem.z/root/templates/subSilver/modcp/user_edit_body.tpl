...
<table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
		...
		<td class="row2"><input type="hidden" name="username" value="{USERNAME}"{DISABLE_CHANGE} /><b><span class="genmed">{USERNAME}</span></b></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_EMAIL_ADDRESS}: *</span></td>
		<td class="row2"><input type="hidden" name="email" value="{EMAIL}" /><b><span class="genmed">{EMAIL}</span></b></td>
	</tr>
	<tr>
		<td class="row1">
			<span class="gen">{L_NEW_PASSWORD}: *</span><br />
			<span class="gensmall">{L_PASSWORD_IF_CHANGED}</span><br />
		</td>
		<td class="row2"><input type="hidden" name="password" value=""{DISABLE_CHANGE} /><span class="genmed"></span></td>
	</tr>
	<tr>
		<td class="row1">
			<span class="gen">{L_CONFIRM_PASSWORD}: * </span><br />
			<span class="gensmall">{L_PASSWORD_CONFIRM_IF_CHANGED}</span><br />
		</td>
		<td class="row2"><input type="hidden" name="password_confirm" value=""{DISABLE_CHANGE} /><span class="genmed"></span></td>
	</tr>
	<!-- END switch_change_disallowed -->
	<!-- BEGIN switch_change_allowed -->
	<tr>
		<td class="row1" width="38%"><span class="gen">{L_USERNAME}: *</span></td>
		<td class="row2"><input class="post" type="text" name="username" size="35" maxlength="40" value="{USERNAME}"{DISABLE_CHANGE} /></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_EMAIL_ADDRESS}: *</span></td>
	...
	<tr>
		...
		<td class="row2"><input class="post" type="password" name="password" size="35" maxlength="32" value=""{DISABLE_CHANGE} /></td>
	</tr>
	<tr>
		<td class="row1">
			<span class="gen">{L_CONFIRM_PASSWORD}: * </span><br />
		...
		<td class="row2"><input class="post" type="password" name="password_confirm" size="35" maxlength="32" value=""{DISABLE_CHANGE} /></td>
	</tr>
	...
	<tr>
		...
		<td class="row2"><input type="hidden" name="icq" value="{ICQ}"{DISABLE_CHANGE} /><span class="genmed">{ICQ}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_AIM}</span></td>
		<td class="row2"><input type="hidden" name="aim" value="{AIM}"{DISABLE_CHANGE} /><span class="genmed">{AIM}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_MESSENGER}</span></td>
		<td class="row2"><input type="hidden" name="msn" value="{MSN}"{DISABLE_CHANGE} /><span class="genmed">{MSN}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_YAHOO}</span></td>
		<td class="row2"><input type="hidden" name="yim" value="{YIM}"{DISABLE_CHANGE} /><span class="genmed">{YIM}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_WEBSITE}</span></td>
		<td class="row2"><input type="hidden" name="website" value="{WEBSITE}"{DISABLE_CHANGE} /><span class="genmed">{WEBSITE}</span></td>
	</tr>
	<tr>
		<td class="row1"><span class="gen">{L_LOCATION}</span></td>
		<td class="row2"><input type="hidden" name="location" value="{LOCATION}"{DISABLE_CHANGE} /><span class="genmed">{LOCATION}</span></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="row2" valign="top"><input type="hidden" name="signature" /><span class="genmed">{SIGNATURE}</span></td>
	</tr>
	<!-- END switch_change_disallowed -->
	<!-- BEGIN switch_change_allowed -->
	<tr>
	...
	<tr>
		...
		<td class="row2"><input class="post" type="text" name="avatarurl" size="40" class="post" style="width: 200px" /></td>
	</tr>
	<!-- END avatar_remote_upload -->
	<!-- BEGIN avatar_remote_link -->
	<tr>
		<td class="row1"><span class="gen">{L_LINK_REMOTE_AVATAR}</span></td>
		<td class="row2"><input class="post" type="text" name="avatarremoteurl" size="40" class="post" style="width: 200px" /></td>
	</tr>
	...
	<tr>
		...
		<td class="row2">
			<input type="radio" name="user_allowpm" value="1"{ALLOW_PM_YES}{DISABLE_CHANGE} />
			<span class="gen">{L_YES}</span>&nbsp;&nbsp;
			<input type="radio" name="user_allowpm" value="0"{ALLOW_PM_NO}{DISABLE_CHANGE} />
			<span class="gen">{L_NO}</span>
		</td>
	</tr>
	<tr>
		...
		<td class="row2">
			<input type="radio" name="user_allowavatar" value="1"{ALLOW_AVATAR_YES}{DISABLE_CHANGE} />
			<span class="gen">{L_YES}</span>&nbsp;&nbsp;
			<input type="radio" name="user_allowavatar" value="0"{ALLOW_AVATAR_NO}{DISABLE_CHANGE} />
			<span class="gen">{L_NO}</span>
		</td>
	</tr>
	<tr>

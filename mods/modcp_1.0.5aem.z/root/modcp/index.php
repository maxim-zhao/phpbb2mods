...
else if ( isset($HTTP_GET_VARS['pane']) && $HTTP_GET_VARS['pane'] == 'right' )
{
	...
	// Advice: if you want to disable one statistic to Mod
	// Take DB_SIZE for example
	$template->assign_vars(array(
		...
		"DB_SIZE" => ( $userdata['user_level'] == ADMIN ) ? $dbsize : $lang['Not_available'],
	...
	//
	$sql = "SELECT u.user_id, u.username, u.user_session_time, u.user_session_page, u.user_allow_viewonline, u.user_level, s.session_logged_in, s.session_ip, s.session_start

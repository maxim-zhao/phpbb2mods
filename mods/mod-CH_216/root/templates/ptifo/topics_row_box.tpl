...
<!-- BEGIN header -->
<tr>
	<td class="catmini" colspan="<!-- BEGIN select -->8<!-- BEGINELSE select -->7<!-- END select -->"><span class="gensmall">
...
<tr>
	<td class="row1" align="center" valign="middle">
		<img src="{topicrow.I_TOPIC_FOLDER}" alt="{topicrow.L_TOPIC_FOLDER}" title="{topicrow.L_TOPIC_FOLDER}" />
	</td>
	<td class="row1" align="center" valign="middle">
	...
	<td class="row1" width="100%"><span class="topictitle">
		...
		<!-- BEGIN pagination --><br />[&nbsp;<img src="{topicrow.topic.pagination.I_GOTO}" border="0" align="top" alt="{topicrow.topic.pagination.L_GOTO}" title="{topicrow.topic.pagination.L_GOTO}" hspace="2" />{topicrow.topic.pagination.L_GOTO}:&nbsp;<!-- BEGIN page_number --><!-- BEGIN number --><a href="{topicrow.topic.pagination.page_number.U_PAGE}" class="gensmall">{topicrow.topic.pagination.page_number.PAGE}</a><!-- BEGIN sep -->, <!-- END sep --><!-- BEGINELSE number -->..., <!-- END number --><!-- END page_number -->&nbsp;]<!-- END pagination -->
	...
	<td class="<!-- BEGIN select -->row1<!-- BEGINELSE select -->row3Right<!-- END select -->" align="center" valign="middle" nowrap="nowrap"><span class="postdetails">&nbsp;
		...
		<!-- BEGIN last_post_link -->&nbsp;<a href="{topicrow.U_LAST_POST}" title="{L_LAST_POST}"><img src="{I_LAST_POST}" alt="{L_LAST_POST}" align="top" border="0" /></a><!-- END last_post_link -->
	</span></td>
	<!-- BEGIN select -->

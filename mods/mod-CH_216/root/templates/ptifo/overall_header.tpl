...
<tr>
	...
	<tr> 
		...
		<td align="center" width="100%" valign="middle"><span class="maintitle">{SITENAME}</span><span class="gen"><br />&nbsp;{SITE_DESCRIPTION}&nbsp;<br /></span>
			...
			<tr>
				<td align="center" valign="top" nowrap="nowrap"><span class="mainmenu">
					<!-- BEGIN switch_user_logged_out -->&nbsp;<a href="{U_REGISTER}" class="mainmenu"><img src="{I_REGISTER}" border="0" alt="{L_REGISTER}" hspace="3" />{L_REGISTER}</a>&nbsp; <!-- BEGINELSE switch_user_logged_out -->&nbsp;<a href="{U_PREFERENCES}" class="mainmenu"><img src="{I_PROFILE}" border="0" alt="{L_PROFILE}" hspace="3" />{L_PROFILE}</a>&nbsp; &nbsp;<a href="{U_PRIVATEMSGS}" class="mainmenu"><img src="{PRIVMSG_IMG}" border="0" alt="{PRIVATE_MESSAGE_INFO}" hspace="3" />{PRIVATE_MESSAGE_INFO}</a>&nbsp; <!-- END switch_user_logged_out -->&nbsp;<a href="{U_LOGIN_LOGOUT}" class="mainmenu"><img src="<!-- BEGIN switch_user_logged_out -->{I_LOGIN}<!-- BEGINELSE switch_user_logged_out -->{I_LOGOUT}<!-- END switch_user_logged_out -->" border="0" alt="{L_LOGIN_LOGOUT}" hspace="3" />{L_LOGIN_LOGOUT}</a>&nbsp;
				</span></td>
			</tr>
			<!-- BEGIN user_is_admin -->
			<tr>
	...
	<tr>
		...
		<td align="right" valign="bottom">
			...
			<!-- BEGIN full_month_ELSE --><!-- BEGINGLOBAL java --><a href="#" onclick="dom_toggle.toggle('calrow','calrow_pic', '{I_DOWN_ARROW}', '{I_UP_ARROW}'); return false;" class="gensmall"><img src="{I_TOGGLE}" id="calrow_pic" hspace="2" border="0" align="top" alt="" />{L_CALENDAR}</a><!-- ENDGLOBAL java --><!-- END full_month_ELSE -->
		</td>
	</tr>
	</table>
	{CALENDAR_BOX}
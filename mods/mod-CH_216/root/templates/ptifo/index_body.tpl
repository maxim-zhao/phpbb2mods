...
<tr>
	...
	<td class="row1" height="50" width="100%">
		...
		<!-- BEGIN subforums -->
		<span class="gensmall">
			<b>{L_SUBFORUMS}:</b>&nbsp;<!-- BEGIN sub --><img src="{indexrow.forum.row.subforums.sub.I_SUB}" border="0" align="top" alt="{indexrow.forum.row.subforums.sub.L_SUB_ALT}" title="{indexrow.forum.row.subforums.sub.L_SUB_ALT}" />&nbsp;<a href="{indexrow.forum.row.subforums.sub.U_SUB}" title="{indexrow.forum.row.subforums.sub.L_SUB_DESC}" class="gensmall">{indexrow.forum.row.subforums.sub.L_SUB}</a><!-- BEGIN sep -->, <!-- END sep --><!-- END sub -->
		<br /></span>
		<!-- END subforums -->
		<!-- BEGIN forum_icon -->
		</td></tr></table>
	...
	<td class="row3Right" align="center" valign="middle" height="50" nowrap="nowrap"><span class="gensmall">
		...
		&nbsp;<a href="{indexrow.forum.U_LAST_POST}" class="gensmall" title="{L_LAST_POST}"><img src="{I_LAST_POST}" align="top" border="0" alt="{L_LAST_POST}" /></a><br />
		<!-- BEGINELSE last_post -->
		{L_NO_POSTS}
		<!-- END last_post -->
	</span></td>
...
<tr>
	...
	<td class="row1" height="50" width="100%">
		...
		<!-- BEGIN subforums -->
		<span class="gensmall">
			<b>{L_SUBFORUMS}:</b>&nbsp;<!-- BEGIN sub --><img src="{indexrow.link.row.subforums.sub.I_SUB}" border="0" align="top" alt="{indexrow.link.row.subforums.sub.L_SUB_ALT}" title="{indexrow.link.row.subforums.sub.L_SUB_ALT}" />&nbsp;<a href="{indexrow.link.row.subforums.sub.U_SUB}" title="{indexrow.link.row.subforums.sub.L_SUB_DESC}" class="gensmall">{indexrow.link.row.subforums.sub.L_SUB}</a><!-- BEGIN sep -->, <!-- END sep --><!-- END sub -->
		<br /></span>
		<!-- END subforums -->
		<!-- BEGIN forum_icon -->
		</td></tr></table>
...
<tr>
	<th class="thHead" height="28"><a name="login"></a>{L_LOGIN_LOGOUT}</th>
</tr>
<tr> 

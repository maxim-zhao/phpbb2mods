...
<tr>
	<td align="center"><a href="{U_FORUM_INDEX}" target="_parent"><img src="{I_LOGO_SMALL}" border="0" alt="" /></a></td>
</tr>
<tr> 
	<td align="center"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	<tr>

...
<h1>{L_ACPUSER_HEADER}</h1>

<p>{L_ACPUSER_EXPLAIN}</p>

{ERROR_BOX}

<span class="gensmall">{ACPUSER_MODE_SWITCH}</span><br />
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<!-- END switch_advanced_mode -->
	<tr> 
		<th class="thHead" colspan="2" height="25" valign="middle">{L_REGISTRATION_OPTIONS}</th>
	</tr>
	<tr>
		<td class="row2" colspan="2"><span class="gensmall">{L_REGISTRATION_OPTIONS_EXPLAIN}</span></td>
	</tr>
	<tr> 
		<td class="row1"><span class="gen">{L_REG_SEND_EMAIL}:</span></td>
		<td class="row2"><input type="radio" name="registration_send_email" value="1" checked="checked" />&nbsp;{L_YES}&nbsp;&nbsp;<input type="radio" name="registration_send_email" value="0" />&nbsp;{L_NO}</td>
	</tr>
	<!-- BEGIN switch_list_groups -->
	<tr>
        <td class="row1"><span class="gen">{switch_list_groups.L_ADD_TO_GROUPS}</span><br /><span class="gensmall">{switch_list_groups.L_ADD_TO_GROUPS_EXPLAIN}</span></td>
        <td class="row2">
            <!-- BEGIN groups_list -->
            &nbsp;<input type="checkbox" name="group[{switch_list_groups.groups_list.S_GROUP_ID}]" />&nbsp;{switch_list_groups.groups_list.S_GROUP_NAME}&nbsp;
            <!-- END groups_list -->
        </td>
    </tr>
    <!-- END switch_list_groups -->
	<tr>

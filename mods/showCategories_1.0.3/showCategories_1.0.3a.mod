...
##		This MOD was tested with EasyMOD 0.2.1a beta (doesn't work for download mode in this version! - try the MOD in the contrib folder if you intend to use this mode of EM). This should be no problem for users of EM 0.2.2 beta as soon as it will come out.
##
## MOD Version:   1.0.3a
##
...
# The upper part of links.
#
# Note: There are two lines like that - this is the first one.
# The next line in subSilver is just: </tr>
#
...
# The lower part of links.
#
# Note: There are two lines like that - this is the second one.
# The next line in subSilver is:

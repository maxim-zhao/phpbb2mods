...
if ( $lang_extend_admin )
{
	...
	$lang['Lang_extend_add_entry'] = 'Ajouter un nouvelle clé';

	$lang['Lang_extend_key_main'] = 'Clé principale';
	$lang['Lang_extend_key_main_explain'] = 'Renseignez ici la clé de langues principale, la seule utilisée dans la majorité des cas.';
	...
	$lang['Lang_extend_delete_done'] = 'Cette clé de langues a été supprimée.<br />Notez que seules les personnalisation sont supprimées, pas les clés existantes dans les packs.<br /><br />Cliquez %sici%s pour retourner à la liste des clés.';
	...
	$lang['Lang_extend_search_no_words'] = 'Vous n\'avez fournis aucun mots à rechercher.<br /><br />Cliquez %sici%s pour retourner à la liste des packs de langues.';

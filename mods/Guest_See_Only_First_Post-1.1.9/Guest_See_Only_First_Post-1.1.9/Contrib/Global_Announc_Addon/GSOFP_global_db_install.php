<?php
/******************************************************************************************
GSOFP_global_db_install.php version 1.1.8	
...
if( !$userdata['session_logged_in'] )
{
	...
	header($header_location . append_sid("login.$phpEx?redirect=GSOFP_global_db_install.$phpEx", true));
	exit;
}
...
$sql = array();
	$sql[] = "ALTER TABLE ".$table_prefix."forums ADD guest_global_announce TINYINT(1) NULL DEFAULT '0'";

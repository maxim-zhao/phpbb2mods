<?php
/******************************************************************************************
 Uninstall_db_Global_Announce_Addon.php version 1.1.8	
 for uninstalling sql for Guest See Only First Post Global Addon 1.1.8	
******************************************************************************************/
...
if( !$userdata['session_logged_in'] )
{
	...
	header($header_location . append_sid("login.$phpEx?redirect=Uninstall_db_Global_Announce_Addon.$phpEx", true));
	exit;
}
...
$sql = array();
$sql[] = "ALTER TABLE `" . $table_prefix . "forums` DROP `guest_global_announce`";

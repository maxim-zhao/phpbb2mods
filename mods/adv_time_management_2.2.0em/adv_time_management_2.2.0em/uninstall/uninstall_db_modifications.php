<?php 
/***************************************************************************
 *                    Uninstall Advanced time management
 *                           --------------------
 *   begin                : Sunday, July 16, 2005
 *   copyright            : (C) 2005 -=ET=-
 *   email                : n/a
 *
 *   $Id: uninstall_db_modifications.php,v 1.0.0 2005/07/16 00:00:00 -=ET=- Exp $
 *
 ***************************************************************************/
...
switch ( $userdata['user_lang'] )
{
	case french:
	case francais:
		$script_lang['mod_name'] = 'Advanced Time Management'; // Ne pas écrire le mot "MOD" dans le nom !
...
//	case german:
//	case deutsch:
//		$script_lang['mod_name'] = 'Advanced Time Management'; // Es darf nicht das Wort "MOD" drin vorkommen !
...
//	case italian:
//	case italiano:
//		$script_lang['mod_name'] = 'Advanced Time Management'; // Non scrivere la parola "MOD" nel nome! 
...
//	case spanish:
//	case espanol:
//		$script_lang['mod_name'] = 'Advanced Time Management'; // No incluya la palabra "MOD" en él nombre!
...
//		break;
	...
	default:
		$script_lang['mod_name'] = 'Advanced time management'; // Do not include the word "MOD" in the name!
...
$sql = array(" 
DELETE FROM ".$table_prefix."config WHERE config_name='default_time_mode' LIMIT 1
","
DELETE FROM ".$table_prefix."config WHERE config_name='default_dst_time_lag' LIMIT 1
","
ALTER TABLE ".$table_prefix."users DROP user_time_mode 
","
ALTER TABLE ".$table_prefix."users DROP user_dst_time_lag 
","
ALTER TABLE ".$table_prefix."users DROP user_pc_timeOffsets 
"); 

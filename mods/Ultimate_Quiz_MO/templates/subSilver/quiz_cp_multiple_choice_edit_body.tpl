	...
	<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
		...
		<tr>
			<td class="row2" colspan="2" align="center" valign="middle">
				<span class="gen">{L_EXPLAIN}<br />{L_CHECK}</span>
			</td>
		</tr>
	...
	<!-- BEGIN edit_row -->
		<tr>
			...
			<td class="row2" width="30%" colspan="1" align="left" valign="middle">
				<span class="gen">
					<input type="text" name="A1_{edit_row.U_QUESTION_ID}" value="{edit_row.U_A1}" /> <input type="radio" name="C_{edit_row.U_QUESTION_ID}" value="A1_{edit_row.U_QUESTION_ID}" /><br />
					<input type="text" name="A2_{edit_row.U_QUESTION_ID}" value="{edit_row.U_A2}" /> <input type="radio" name="C_{edit_row.U_QUESTION_ID}" value="A2_{edit_row.U_QUESTION_ID}" /><br />
					<input type="text" name="A3_{edit_row.U_QUESTION_ID}" value="{edit_row.U_A3}" /> <input type="radio" name="C_{edit_row.U_QUESTION_ID}" value="A3_{edit_row.U_QUESTION_ID}" /><br />
					<input type="text" name="A4_{edit_row.U_QUESTION_ID}" value="{edit_row.U_A4}" /> <input type="radio" name="C_{edit_row.U_QUESTION_ID}" value="A4_{edit_row.U_QUESTION_ID}" />
				</span>
			</td>
		</tr>
	<!-- END edit_row -->	

<form method="post" action="{F_FORM}">
	<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
		<tr>
			<th colspan="1" width="100%" class="thTop" nowrap="nowrap">&nbsp;{L_MCP}&nbsp;</th>
		</tr>
		
		<tr>
			<td class="row1" align="center" valign="middle" height="50"><span class="gen">{L_SURE}</span></td>
		</tr>
		
		<tr>
			<th colspan="3" class="catBottom" align="center" height="28">
				<input class="liteoption" type="submit" name="delete" value="{L_YES}" />
			</th>
		</tr>
	</table> 
</form> 

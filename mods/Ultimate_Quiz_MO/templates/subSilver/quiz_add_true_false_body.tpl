...
<input type="hidden" name="Quiz_Type" value="True_False">
...
{L_TRUE}
<input type="radio" name="Correct_Answer_{question_number.U_UNIQUE}" value="{L_TRUE}" /><br />
{L_FALSE}
<input type="radio" name="Correct_Answer_{question_number.U_UNIQUE}" value="{L_FALSE}" /><br />
</span></td>
</tr>
<!-- END question_number -->  
<tr>

...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
		<tr>
			<th colspan="3" width="100%" class="thTop" nowrap="nowrap">&nbsp;{U_QUIZ_NAME}&nbsp;</th>
		</tr>
	...
	<!-- BEGIN quiz_row -->
		...
		<tr>
			<td class="row1" width="50%" align="center" valign="middle" height="100%">
				<span class="forumlink">
					{quiz_row.U_QUESTION}
				</span>
			</td>
			
			<td class="row2" width="50%" align="center" valign="middle" height="100%">
				<span class="gen">
					<input type="radio" name="{quiz_row.U_QUESTION_ID}" value="{L_TRUE}" /> {L_TRUE}
					<br>
					<input type="radio" name="{quiz_row.U_QUESTION_ID}" value="{L_FALSE}" /> {L_FALSE}
				</span>
			</td>
		</tr>
	<!-- END quiz_row -->

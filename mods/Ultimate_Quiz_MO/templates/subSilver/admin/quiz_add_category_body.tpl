...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	<tr>
		<td colspan="3" align="center" width="100%" class="catSides" nowrap="nowrap">&nbsp;<span class="cattitle">{L_ADD}</span>&nbsp;</td>
	</tr>
	...
	<tr>
		<td width="34%" colspan="1" class="row1" align="center" valign="middle" height="100%">
			<span class="gen">{L_NAME} <input type="text"  size="10" name="name" value="" /></span>
		</td>

		<td width="33%" colspan="1" class="row1" align="center" valign="middle" height="100%">
			<span class="gen">{L_DESCRIPTION} <input type="text"  size="10" name="description" value="" /></span>
		</td>

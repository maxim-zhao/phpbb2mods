...
To use the new password an administrator have to avctivate it. After this you will get a second confirmation email.

If you've got this confirmation email you will be able to login using the following password:

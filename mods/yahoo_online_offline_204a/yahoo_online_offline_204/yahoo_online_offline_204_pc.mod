...
##                  When cliked on icon, Yahoo messanger that is installed on PC window will popup.
## MOD Version: 2.0.4 - PC
## 
...
#
		...
		//$yim_img = ( $postrow[$i]['user_yim'] ) ? '<a href="http://edit.yahoo.com/config/send_webmesg?.target=' . $postrow[$i]['user_yim'] . '&amp;.src=pg"><img src="' . $images['icon_yim'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
     		$yim_img = ( $postrow[$i]['user_yim'] ) ? '<a href="ymsgr:sendim?' . $postrow[$i]['user_yim'] . '"><img src="' . $images['icon_yim_status'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
		$yim_status_img = ( $postrow[$i]['user_yim'] ) ? '<a href="ymsgr:sendim?' . $postrow[$i]['user_yim'] . '"><img src="http://opi.yahoo.com/online?u=' . $postrow[$i]['user_yim'] . '&m=g&t="' . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
		// MOD - YAHOO ONLINE/OFFLINE - donpedro00
#
#-----[ FIND ]-------------------------------------
#
...
#
      // MOD - YAHOO ONLINE/OFFLINE - donpedro00
	//$yim_img = ( $privmsg['user_yim'] ) ? '<a href="http://edit.yahoo.com/config/send_webmesg?.target=' . $privmsg['user_yim'] . '&amp;.src=pg"><img src="' . $images['icon_yim'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
      $yim_img = ( $privmsg['user_yim'] ) ? '<a href="ymsgr:sendim?' . $privmsg['user_yim'] . '"><img src="' . $images['icon_yim_status'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
      $yim_status_img = ( $privmsg['user_yim'] ) ? '<a href="ymsgr:sendim?' . $privmsg['user_yim'] . '"><img src="http://opi.yahoo.com/online?u=' . $privmsg['user_yim'] . '&m=g&t="' . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
      // MOD - YAHOO ONLINE/OFFLINE - donpedro00
#
#-----[ FIND ]-------------------------------------
#
...
// MOD - YAHOO ONLINE/OFFLINE - donpedro00
//$yim_img = ( $profiledata['user_yim'] ) ? '<a href="http://edit.yahoo.com/config/send_webmesg?.target=' . $profiledata['user_yim'] . '&amp;.src=pg"><img src="' . $images['icon_yim'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
$yim_img = ( $profiledata['user_yim'] ) ? '<a href="ymsgr:sendim?' . $profiledata['user_yim'] . '"><img src="' . $images['icon_yim_status'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
$yim_status_img = ( $profiledata['user_yim'] ) ? '<a href="ymsgr:sendim?' . $profiledata['user_yim'] . '"><img src="http://opi.yahoo.com/online?u=' . $profiledata['user_yim'] . '&m=g&t="' . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
// MOD - YAHOO ONLINE/OFFLINE - donpedro00
#
#-----[ FIND ]-------------------------------------
#

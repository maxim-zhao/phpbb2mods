/*************************************************************
 *	DHTML Collapsible FAQ MOD v1.0.2
 *
 *	Copyright (C) 2004-2005, Markus (http://www.phpmix.com)
...
var _CFAQ_oldload = window.onload;
window.onload = function()
{
	...
	var faq_id = ( window.location.hash.length > 0 ? parseInt(window.location.hash.substring(1)) : -1 );
	if( faq_id >= 0 )
	{
		CFAQ.display('faq_a_'+faq_id, false);
	}
}
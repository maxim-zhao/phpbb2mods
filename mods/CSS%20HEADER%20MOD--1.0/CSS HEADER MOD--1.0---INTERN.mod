...
## MOD Author: bloody_nOOb < bloodhaunter@flashmail.com > (bloody_nOOb) http://bloodhaunter.funpic.de/
...
##############################################################
## Author Notes: Use this Version ONLY if you use a Intern CSS.
## If you want to use this MOD in other Styles then subSilver just repeat the Install-Steps for  every installed Style where you like to use this MOD.
##############################################################
## MOD History:
## 

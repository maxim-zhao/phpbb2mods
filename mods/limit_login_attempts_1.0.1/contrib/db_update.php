...
//
$sql = array();
$sql[] = 'CREATE TABLE ' . $table_prefix . 'login (
    ip VARCHAR(8) NOT NULL DEFAULT \'\',
    number TINYINT(1) NOT NULL DEFAULT 1,
    login_time INTEGER(11) NOT NULL DEFAULT 0
)';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'login_tries\',5)';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'login_locked_out\',15)';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name,config_value) VALUES(\'login_try\',1440)';
$sql_count = count($sql);

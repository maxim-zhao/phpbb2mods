...
if ($mode != '')
{
	if ($mode == 'edit' || $mode == 'add')
	{
		...
		$template->set_filenames(array('body' => 'admin/spamwords_edit_body.tpl'));
	...
	elseif($mode == 'massad')
	{
		$template->set_filenames(array('body' => 'admin/spamwords_mass_ad.tpl'));
		
        $template->assign_vars(array(
        	'L_MASS_AD' => $lang['Mass_ad'],
        	'L_MASS_AD_EXPLAIN' => $lang['Mass_ad_explain'],
        	'L_MASS_AD_EXPLAIN2' => $lang['Mass_ad_explain2'],
        	'L_SUBMIT' => $lang['Submit']
        ));
...
{
	$template->set_filenames(array('body' => 'admin/spamwords_list_body.tpl'));
	...
	(
		...
		'S_WORDS_ACTION' => append_sid("admin_spamwords.$phpEx"),
		'S_HIDDEN_FIELDS' => '',
		'U_WORD_MASS_AD' => append_sid("admin_spamwords.$phpEx?mode=massad")
	));

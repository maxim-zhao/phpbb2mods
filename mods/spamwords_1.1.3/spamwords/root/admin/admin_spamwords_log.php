 ...
 * File Name:       admin_spamwords_log.php
 * File Path:       admin/
...
$template->set_filenames(array('body' => 'admin/spamwords_log_body.tpl'));
...
if ($log_count == 0)
{
	$template->assign_block_vars('no_log', array('L_NO_LOG' => $lang['No_log']));
}

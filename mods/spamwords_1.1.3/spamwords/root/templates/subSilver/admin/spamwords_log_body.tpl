...
<p>
<span class="genmed">{L_LOG_EXPLAIN}</span></p>
...
<form method="post" action="{S_MODE_ACTION}">
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<!-- BEGIN no_log -->
	<tr>
	  <td class="row1" align="center" colspan="6"><span class="gen">{no_log.L_NO_LOG}</span></td>
	</tr>
	<!-- END no_log -->
	<!-- BEGIN log_row -->
	<tr>
...
<!-- END log_row -->
	<tr>
		<td colspan="6" class="catBottom" align="center"><input class="liteoption" type="submit" name="delete" value="{L_DELETE}"></td>
	</tr>
</table>
</form>

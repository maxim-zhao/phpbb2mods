...
<!-- END flagged -->
<!-- BEGIN switch_no_flagged -->
<tr>
  <td class="row1" colspan="5" align="center" height="28"><span class="gen">{L_NO_FLAGGED_POSTS}</span></td>
</tr>
<!-- END switch_no_flagged -->
<tr>
  <td colspan="7" align="center" class="catBottom">
  <!-- BEGIN switch_flagged_posts -->
  <input type="submit" name="submit" value="{L_DELETE_ALL_FLAGGED}" />
	<!-- END switch_flagged_posts -->
  &nbsp;</td>
</tr>
</table>

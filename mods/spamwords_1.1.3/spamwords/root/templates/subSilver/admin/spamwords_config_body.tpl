...
<form action="{S_CONFIG_ACTION}" method="post">
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
	  <td class="row1"><span class="gen">{L_DISABLE_MOD}</span>
		<br />
		<span class="gensmall">{L_DISABLE_MOD_EXPLAIN}</span></td>
	...
	<tr>
	  <td class="row1"><span class="gen">{L_HANDLE_SPAM}</span>
		<br />
		<span class="gensmall">{L_HANDLE_SPAM_EXPLAIN}</span></td>
	  <td class="row2" nowrap="nowrap"><input type="radio" name="flag_posts" value="1" {S_FLAG_POSTS} />{L_FLAG_POSTS}
		<br />
		<input type="radio" name="flag_posts" value="0" {S_ERROR_MESSAGE} />{L_ERROR_MESSAGE}</td>
	</tr>
	<tr>
	  <td class="row1"><span class="gen">{L_OFFENSES}</span>
		<br />
		<span class="gensmall">{L_OFFENSES_EXPLAIN}</span></td>
	...
	<tr>
	  <td class="row1"><span class="gen">{L_PM_SELECT_ADMIN}</span></td>
	  <td class="row2" nowrap="nowrap">{S_SELECT_ADMIN}</td>
	</tr>
	<tr>

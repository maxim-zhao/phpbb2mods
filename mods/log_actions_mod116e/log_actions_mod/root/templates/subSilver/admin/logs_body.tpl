...
<span class="gen">[ {L_WHOSONLINE_ADMIN} ] &nbsp; [ {L_WHOSONLINE_MOD} ]<br />
...
<tr>
		...
		<td class="row1"><center><a href="{record_row.U_ACTION}" onclick="window.open('{record_row.U_ACTION}', '_rules', 'HEIGHT=250, resizable=no, WIDTH=400, screenX=313,screenY=259,left=313,top=259');return false;" target="_rules">{record_row.ACTION}</a></center></td>

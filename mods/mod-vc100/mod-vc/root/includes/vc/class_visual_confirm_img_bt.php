<?php
//
//	file: includes/class_visual_confirm_img_bt.php
//	author: ptirhiik
//	begin: 17/03/2006
//	version: 1.6.1 - 04/01/2007
...
class visual_confirm_img_bt extends visual_confirm_img
{
	...
	function text(&$dst)
	{
		...
		// font
		$font_range = array(0, count($this->fonts) - 1);
		$ratio_range = array(75, 125);
		$angle_range = array(-30, +30);

...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr>
		<td class="catBottom" align="center" height="28" colspan="2"><input type="hidden" value="delete_model" name="mode" /><input name="submit" type="submit" value="{L_DELETE_MODEL_BUTTON}" class="liteoption" /></td>
	</tr>
</table>
</form>

<?php /**********************************************************
*       sql_updater.php for User Disable Colored Text MOD       *
*             Copyright © 2007 Thomas Hall (xx521xx)            *
* File created: 1/4/07                    Last modified: 1/6/07 *
*****************************************************************
*                      File version: 1.0.0                      *
*****************************************************************
...
else
{
	...
	$sql = 'ALTER TABLE '.USERS_TABLE.'
		ADD user_allow_coloredtxt tinyint(1) DEFAULT 1';
	
	$message = 'Adding user_allow_coloredtxt to '.USERS_TABLE.'...';
	...
	else
	{
		...
		$error = true;
		$manual_instructions .= 'ALTER TABLE '.USERS_TABLE.' ADD user_allow_coloredtxt tinyint(1) DEFAULT 1;';
	}

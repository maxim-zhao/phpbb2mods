...
//
function validate_optional_fields(&$icq, &$aim, &$msnm, &$yim, &$xfi, &$website, &$location, &$occupation, &$interests, &$sig)
{
	$check_var_length = array('aim', 'msnm', 'yim', 'silk', 'location', 'occupation', 'interests', 'sig');

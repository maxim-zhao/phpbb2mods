...
//
$sql = array();
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name, config_value) VALUES (\'default_avatar\', \'0\');';
$sql[] = 'UPDATE ' . $table_prefix . 'config SET config_name = \'default_avatar_guests\' WHERE config_name = \'default_avatar_guests_url\';';
$sql[] = 'UPDATE ' . $table_prefix . 'config SET config_name = \'default_avatar_users\' WHERE config_name = \'default_avatar_users_url\';';
$sql[] = 'UPDATE ' . $table_prefix . 'config SET config_name = \'default_avatar_type\' WHERE config_name = \'default_avatar_set\';';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name, config_value) VALUES (\'default_avatar_random\', \'0\');';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name, config_value) VALUES (\'default_avatar_choose\', \'0\');';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name, config_value) VALUES (\'default_avatar_override\', \'0\');';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'users ADD user_allowdefaultavatar TINYINT(1) DEFAULT \'1\' NOT NULL;';
$sql_count = count($sql);

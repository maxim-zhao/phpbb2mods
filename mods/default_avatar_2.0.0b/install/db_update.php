...
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name, config_value) VALUES (\'default_avatar_guests\', \'\');';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name, config_value) VALUES (\'default_avatar_users\', \'\');';
$sql[] = 'INSERT INTO ' . $table_prefix . 'config(config_name, config_value) VALUES (\'default_avatar_type\', \'1\');';

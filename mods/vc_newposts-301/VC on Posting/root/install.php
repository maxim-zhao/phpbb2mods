...
$mod = array(
	'name'			=>	'Visual Confirmation on New Posters',
	'version'		=>	'3.0.1',
	'copy_year'		=>	'2006',
	'author'		=>	'Thoul',
...
switch( $dbms )
{
	case 'postgres':
		$sql["install"] = array(
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_max_posts','1')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_enable','1')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_type','0')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_webcheck','1')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_rand1','100')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_rand2','400')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_rand3','450')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_rand4','16000')",
	"INSERT INTO " . $table_prefix . "config(config_name,config_value) VALUES('vcnewposts_rand5','67984')");

		$sql["uninstall"] = array(
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_max_posts'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_enable'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_type'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_webcheck'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_rand1'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_rand2'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_rand3'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_rand4'",
	"DELETE FROM " . $table_prefix . "config WHERE config_name = 'vcnewposts_rand5'");

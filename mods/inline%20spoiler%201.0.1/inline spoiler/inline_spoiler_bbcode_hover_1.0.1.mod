#################################################################
## MOD Title: Inline Spoiler Hover BBcode MOD
...
##              posted by the user. Mouseover to view. [spoiler] Spoiler Text [/spoiler]
##
## MOD Version: 1.0.1
##
...
##
## I'd like to thank eviL<3 for the additional mouseover code.
##
...
##
## 2006-1-20 - version 0.8.0
##        - Added mouseover code courtesy of eviL<3
##
...
#-----[ BEFORE, ADD ]------------------------------------------
#
$faq[] = array('Inline Spoiler Tag', "The Inline Spoiler Tag allows a user to type spoilers without the need for skipping lines allowing to hide names or other facts that may be scattered throughout a post without making it look sloppy.<br /><br /><br />[spoiler] Hidden Text [/spoiler]<br /><br /><span class=\"spoiler\" onmouseover=\"this.style.color='white';\" onmouseout=\"this.style.color='black';\">Hidden Text</span>");

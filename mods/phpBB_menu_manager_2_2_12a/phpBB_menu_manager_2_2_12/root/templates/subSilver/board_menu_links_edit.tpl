...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <tr>
	...
	<td class="row2" align="left" width="80%"><span class="gen">
		<input type="text" name="bl_link" size="50" maxlength="50" value="{BLLINK}" /></span><br />
		<span class="gensmall">{L_BL_LINK_EXPLAIN}</span>
	</td>
  </tr>
  <tr>
	<td class="row1" align="right" width="20%"><span class="gen">{L_BL_PARAMETER}</span></td>
	<td class="row2" align="left" width="80%"><span class="gen">
		<input type="text" name="bl_parameter" size="50" maxlength="50" value="{BLPARAMETER}" /></span><br />
		<span class="gensmall">{L_BL_PARAMETER_EXPLAIN}</span>
	</td>
  </tr>
  <tr>
	<td class="row1" align="center" width="100%" colspan="2"><span class="gen">
		...
		<input type="submit" name="manage_links" value="{L_PREVIOUS}" class="liteoption" /></span>
	</td>
  </tr>
</table>
</form>

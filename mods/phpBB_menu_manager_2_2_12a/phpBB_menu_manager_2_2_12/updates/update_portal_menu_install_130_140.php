...
$sql = array();
$sql[] = "ALTER TABLE " . $table_prefix . "board_menu_cat ADD show_cat_name TINYINT( 1 ) DEFAULT '1' NOT NULL";
$sql[] = "ALTER TABLE " . $table_prefix . "board_menu_cat ADD show_seperator TINYINT( 1 ) DEFAULT '0' NOT NULL";

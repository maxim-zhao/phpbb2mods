...
<!-- BEGIN admin_options -->
  ...
  <tr>
	<td class="row1" align="center" width="100%"><input type="submit" name="manage_categories" style="width: 450px" value="{admin_options.L_MANAGE_CATEGORIES}" class="mainoption" /></td>
  </tr>
  <tr>
	<td class="row1" align="center" width="100%"><input type="submit" name="sort_cat" style="width: 450px" value="{admin_options.L_SORT_CAT}" class="mainoption" /></td>
  </tr>
  <tr>
